...
function position() {
  ...
  var size2 = 991;
  var size4 = 768;
  if (doc_width >= size1 || (doc_width >= size2 && doc_width < size1)) {
    flex();
  } else if (doc_width > size4 && doc_width < size2) {
    flex2();
  } else if (doc_width <= size4) {
    height_elem1.style.top = 0;
    height_elem2.style.top = 0;
    height_elem3.style.top = 0;
    height_elem4.style.top = 0;
    height_elem5.style.top = 0;
    height_elem6.style.top = 0;
    height_elem7.style.top = 0;
    height_elem8.style.top = 0;
    height_elem9.style.top = 0;

    height_elem1.style.right = 0;
    height_elem2.style.right = 0;
    height_elem3.style.right = 0;
    height_elem4.style.right = 0;
    height_elem5.style.right = 0;
    height_elem6.style.right = 0;
    height_elem7.style.right = 0;
    height_elem8.style.right = 0;
    height_elem9.style.right = 0;
  } else {
...
function flex() {
  ...
  height_elem9.style.top = row1_2 * 1.2 + "px";
...
function flex2() {
  ...
  let delta1 = height1 - height2;
  let delta2 = height4 - height3 + delta1;
  ...
  height_elem1.style.top = 0;
  height_elem2.style.top = 0;
  height_elem3.style.top = row1 + "px";
  height_elem4.style.top = 0;
  height_elem5.style.top = row2 + "px";
  height_elem6.style.top = 0;
  height_elem7.style.top = row2 + "px";
  height_elem8.style.top = 0;
  height_elem9.style.top = row2 + "px";

  let width1 = width_elem1.offsetWidth;
  let width2 = height_elem9.offsetWidth;

  let delta_w1 = width1 - width2;

  let column1 = 0 - delta_w1;
  ...
  height_elem7.style.right = 0;
  height_elem8.style.right = 0;
  height_elem9.style.right = column1 + "px";
}
function show_img(){
    height_elem1.style.top = 0;
    height_elem2.style.top = 0;
